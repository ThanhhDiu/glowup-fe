...
export const ProfileHeader: React.FC<{ profile: ProfileHeaderProps, onBack?: () => void, onReviewsClick?: () => void }> = ({ profile, onBack, onReviewsClick }) => {
  return (
    <div className="profile-header-container">
      ...
      <div className="ph-content">
        ...
        <div className="ph-info-section">
          ...
          <div className="ph-stats-row">
            ...
            <div className="ph-stat-item location">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-500"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path><circle cx="12" cy="10" r="3"></circle></svg>
        ...
        <div className="ph-action-section">
          <button className="ph-primary-btn">
