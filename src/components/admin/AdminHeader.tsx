...
export const AdminHeader: React.FC<AdminHeaderProps> = ({
  ...
  const searchBindings = typeof searchValue === 'string' || onSearchChange
    ? {
        value: searchValue ?? '',
  ...
  return (
    <header className="adm-header">
      <div className="adm-search-box">
        <svg className="adm-search-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
        <input
          type="text"
      ...
      <div className="adm-header-actions">
        <button className="adm-icon-btn" type="button" aria-label="Thông báo quản trị">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>
          <span className="adm-notif-dot"></span>
        </button>
        <button className="adm-icon-btn" type="button" aria-label="Cài đặt nhanh">
